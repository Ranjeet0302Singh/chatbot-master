...
function App() {
  ...
  const handleInput = () => {
    ...
    if (words9.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "The owner of this bot is Ranjeet";
        inputRef.value = ""; // clear the input
      }, 2000);
    }

    let owner2 = [
      "Who's Ranjeet|who's Ranjeet|Who is Ranjeet|who is Ranjeet",
    ];
    ...
    if (words10.test(document.querySelector("#input").value)) {
      ...
      setTimeout(() => {
        getBotMessage.innerText =
          "Ranjeet is a programmer based on ReactJS and NodeJS he is the owner of a youtube channel called Creative Tutorials";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
